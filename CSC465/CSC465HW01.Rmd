...
newbirthwt$nonsmoke <- newbirthwt$smoke-1
newbirthwt$smoke <- as.factor(newbirthwt$smoke)
...
data = data.frame(age)
value = predict(lm(bwt ~ age), data)
plot(value, age)

data = data.frame(smoke)
value = predict(lm(bwt ~ smoke), data)
plot(value, age)

data = data.frame(smoke, age)
value = predict(lm(bwt ~ smoke + age), data)
plot(value, age)

data = data.frame(smoke, smoke:age)
value = predict(lm(bwt ~ smoke + smoke:age), data)
plot(value, age)

data = data.frame(smoke, nonsmoke:age)
value = predict(lm(bwt ~ smoke + nonsmoke:age), data)
plot(value, age)
